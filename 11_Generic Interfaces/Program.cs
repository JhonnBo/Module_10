namespace _11_Generic_Interfaces
{
    ...
    {
        //IComparable<in T> Определяет обобщенный метод сравнения, который реализуется
        //типом значения или классом для создания метода сравнения
        //с целью упорядочения или сортировки экземпляров.
        string name;
        string city;
        int year;
        ...
        public void Show()
        {
            Console.WriteLine("{0}   {1}   {2}", name, city, year);
        }
